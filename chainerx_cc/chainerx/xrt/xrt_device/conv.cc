...
Array XrtDevice::Conv(
    ...
    Array col = xrt_internal::Im2Col(x, kernel_size, stride, pad, cover_all, 0);
...
Array XrtDevice::ConvGradWeight(
        Dtype w_dtype,
        const Shape& w_shape,
        const Array& x,
        const Array& gy,
...
Array XrtDevice::ConvTranspose(
    ...
    Array y = xrt_internal::Col2Im(col, stride, pad, out_size);  // shape: batch_size, out_channel, out_size...

...
void XrtDevice::ArgMax(const Array& a, const Axes& axis, const Array& out) {
...
void XrtDevice::Sum(const Array& a, const Axes& axis, const Array& out) {
...
void XrtDevice::AMax(const Array& a, const Axes& axis, const Array& out) {
    CHAINERX_ASSERT(internal::IsValidReductionShape(a.shape(), axis, out.shape(), true));
    CheckDevicesCompatible(a, out);

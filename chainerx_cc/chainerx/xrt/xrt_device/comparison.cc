...
void XrtDevice::Equal(const Array& x1, const Array& x2, const Array& out) {
...
void XrtDevice::NotEqual(const Array& x1, const Array& x2, const Array& out) {
    CheckDevicesCompatible(x1, x2, out);
    Dtype dtype = PromoteTypes(x1.dtype(), x2.dtype());
    const Array& x1_cast = x1.dtype() == dtype ? x1 : x1.AsType(dtype);
    const Array& x2_cast = x2.dtype() == dtype ? x2 : x2.AsType(dtype);
...
void XrtDevice::Greater(const Array& x1, const Array& x2, const Array& out) {
    CheckDevicesCompatible(x1, x2, out);
    Dtype dtype = PromoteTypes(x1.dtype(), x2.dtype());
    const Array& x1_cast = x1.dtype() == dtype ? x1 : x1.AsType(dtype);
    const Array& x2_cast = x2.dtype() == dtype ? x2 : x2.AsType(dtype);
...
void XrtDevice::GreaterEqual(const Array& x1, const Array& x2, const Array& out) {
    CheckDevicesCompatible(x1, x2, out);
    Dtype dtype = PromoteTypes(x1.dtype(), x2.dtype());
    const Array& x1_cast = x1.dtype() == dtype ? x1 : x1.AsType(dtype);
    const Array& x2_cast = x2.dtype() == dtype ? x2 : x2.AsType(dtype);
...
void XrtDevice::LogicalNot(const Array& x, const Array& out) {

...
void XrtDevice::Take(const Array& a, const Array& indices, int8_t axis, const Array& out) {
...
void XrtDevice::AddAt(const Array& a, const Array& indices, int8_t axis, const Array& b, const Array& out) {
